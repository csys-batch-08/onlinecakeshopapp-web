...
<label for="FromDate">From Date : <br><input type="date" name="FromDate"  class="today" id="maxDate" required></label>

<label for="ToDate" >To Date : <br><input type="date" name="ToDate"  class="today" id="startDate" required></label>
